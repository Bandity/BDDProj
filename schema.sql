...
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Nikolai', 'Tony', 42784, 1);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Brittany', 'Warrior', 9841, 6);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Pearl', 'Killdeer', 6, 4);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Elwira', 'Hooker', 4, 5);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Florrie', 'Westend', 81, 4);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Matthias', 'Boyd', 81238, 4);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Mel', 'Washington', 00, 6);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Coralie', 'Welch', 3, 7);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Sidoney', 'Eagan', 1, 7);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Hanny', 'Ronald Regan', 81, 2);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Anna', 'Helena', 5514, 7);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Bram', 'Golf Course', 4, 7);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Stanley', 'Blaine', 176, 3);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Brennen', 'Hazelcrest', 103, 4);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Valdemar', 'Arizona', 14, 2);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Dalis', 'Northport', 46332, 2);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Melinda', 'Debs', 577, 5);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Charla', 'Golden Leaf', 4292, 6);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Valera', 'Hoepker', 00, 6);
insert into Client (nomClient, addressClient, codePostalClient, idVille) values ('Carena', 'Sutherland', 4117, 2);
